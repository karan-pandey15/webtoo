...
//           <Text style={styles.title}>Basket Ball Coaching for Aspiring Players</Text>
...
const basketballScreen = () => {
  ...
  const selectedAcademy = {
    title: 'Basket Ball Coaching for Aspiring Players',
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        {activeTab === 'details' ? (
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionTitle}>Program Description</Text>
            <Text style={styles.descriptionText}>
              Our comprehensive coaching program offers personalized training with
