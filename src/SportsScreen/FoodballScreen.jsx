...
//     title: "FootBall Coaching for Aspiring Players",
//     price: "₹35000 / month",
...
//               Our comprehensive cricket coaching program offers personalized training with experienced coaches.
...
//         <View style={styles.infoContainer}>
//           <Text style={styles.title}>Cricket Coaching for Aspiring Players</Text>
...
//   const navigation = useNavigation(); 
//   const [selectedAcademy, setSelectedAcademy] = useState({
//     title: "Cricket Coaching for Aspiring Players",
//     price: "₹35000 / month",
//     taxInfo: "(Inclusive of all taxes)",
//   });
//   const [name, setName] = useState('');
...
//   const [activeTab, setActiveTab] = useState('details');
//   const [modalVisible, setModalVisible] = useState(false);
//   const [feeType, setFeeType] = useState(null); // State to track selected fee type
...
//                 <TouchableOpacity
//                   style={[styles.feeOption, feeType === 'registration' && styles.activeFeeOption]}
//                   onPress={() => {
...
//                 </TouchableOpacity>
//                 <TouchableOpacity
//                   style={[styles.feeOption, feeType === 'monthly' && styles.activeFeeOption]}
//                   onPress={() => {
//                     setFeeType('monthly');
//                     setFeeAmount('3500');
//                   }}
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        {activeTab === 'details' ? (
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionTitle}>Program Description</Text>
            <Text style={styles.descriptionText}>
              Our comprehensive Football coaching program offers personalized training with
