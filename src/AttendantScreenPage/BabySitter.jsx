    ...
    <View>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={{ uri: 'https://example.com/babysitting-image.jpg' }} // replace with a suitable babysitting image URL
            style={styles.image}
            resizeMode="contain"
          />
        </View>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.title}>Professional Babysitting Service</Text>
          <Text style={styles.price}>₹200 / hr</Text>
        ...
        {activeTab === 'details' ? (
          <View style={styles.descriptionContainer}>
            ...
            <Text style={styles.descriptionText}>
              Our professional babysitting service provides reliable and caring babysitters to help care for your little
              ones. We offer personalized attention, engaging activities, and a safe environment so you can enjoy peace of
              mind while away. Let us handle the details, and trust our experienced team to keep your children happy and safe!
            </Text>
          </View>
        ) : (
          <View style={styles.additionalInfoContainer}>
            <Text style={styles.additionalInfoTitle}>Service Schedule</Text>
            <Text style={styles.additionalInfoText}>Available Daily, 9:00 AM - 9:00 PM</Text>
          </View>
        )}
